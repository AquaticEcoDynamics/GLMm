function [writeTable,plotTable,dates]=Run_LA( LakeName,Folder,skipLoad)

%----Author: Jordan S Read 2009 ----
% Adding writeTable and plotTable as return variables

%Modified 17/12/2012 Sri Adiyanti to return output file for plotting in run LaGLM
...
if TT.findLyr
    ...
    thermoD = ones(varL,1)*depthAry(numDepths);
    metaT = thermoD;
